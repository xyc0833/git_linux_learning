...
- [ ] **面试需要复盘的点**
  - [ ] 下载 仕様書 学习式样书相关的内容
  - [ ] 厚生労働省「シームレスな健康情報活用基盤実証事業」 システム仕様書 
    - 描述： 21页 学习一下
  - [ ] 选择器 css相关内容复习 类选择器用.  ID选择器用#

  - [ ] 先复习 javaScript
  - [ ] jquery 通盘的复习一下？里面 通过 # 得到相应内容 
  - [ ] vue 能写吗
  - [ ] js 相关的内容会吗？
  - [ ] 前后端传值 有很多种方式？
    - 描述 ： 参考柏码曾经做过的项目 和 用户中心项目 看一下 前后端 如何传值？
  - [ ] 前后端传值 比方说依赖注入？
  - [ ] 为什么要用index
  - [ ] 存储引擎
  - [ ] mysql的索引
  ...
  - [ ] 同一个事务当中 锁是什么状态
  - [ ] 不同的事务当中 锁是什么状态
  - [ ] mysql的执行计划 自己去建一个表 看一看 写一个复杂的sql 看看到底在做什么
  - [ ] js 相关的内容会吗？
  - [ ] 有时间的话准备一下 linux的问题 没有就算了

  - [x] html简单复习
  - [ ] html 面试题
  - [ ] css 菜鸟教程回顾 看colajun视频
  - [ ] css 面试鸭 面试题
  - [ ] js 菜鸟教程学习 或者看一下 柏码 和 colajun
  - [ ] js 面试题

  - [ ] 学习vue 菜鸟教程
  - [ ] vue 面试题

- [ ] **面试复盘 问题准备 2026.3.24_8** - 
  - [ ] 
  - [ ] 韩国周日配送 这个需求的难点 
  - [ ] 韩国周日配送 bug对策 时间类的异常处理
  - [ ] 
  - [ ]
  - [ ] 
  - [ ]  
